...
CREATE TABLE IF NOT EXISTS `matcha`.`users` (
  ...
  `password` CHAR(128) NOT NULL DEFAULT '06948d93cd1e0855ea37e75ad516a250d2d0772890b073808d831c438509190162c0d890b17001361820cffc30d50f010c387e9df943065aa8f4e92e63ff060c',
  ...
  `attraction` VARCHAR(100) DEFAULT 'Both',
